...
public class ActionInterpreterTests
{
    ...
    {
        var signal = ActionInterpreter.Interpret([2f, 0.5f, 0.8f, 0f]);
    ...
    {
        var signal = ActionInterpreter.Interpret([-2f, 0.5f, 0.5f, 0f]);
    ...
    {
        var signal = ActionInterpreter.Interpret([0.05f, 0.5f, 0.5f, 0f]);
    ...
    {
        var signal = ActionInterpreter.Interpret([0f, 0f, 0f, 3f]);
    ...
    {
        var signal = ActionInterpreter.Interpret([0f, 0f, 0f, -2f]);
        Assert.False(signal.ExitCurrent);
    }
    ...
    {
        var signal = ActionInterpreter.Interpret([1f, 100f, 0f, 0f]);
